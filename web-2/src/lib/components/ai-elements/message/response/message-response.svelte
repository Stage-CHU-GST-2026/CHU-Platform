...
<div
	class={cn(
		...
		// Streamdown Image Container & Download Button Scope (Top-Right Alignment, Hover Only)
		"[&_[data-streamdown-image]]:relative [&_[data-streamdown-image]]:group [&_[data-streamdown-image]]:inline-block [&_[data-streamdown-image]]:max-w-full [&_[data-streamdown-image]]:my-4",
		"[&_img]:my-5 [&_img]:rounded-2xl [&_img]:border [&_img]:border-border/60 [&_img]:shadow-md [&_img]:max-w-full [&_img]:h-auto",
		"[&_[data-streamdown-image]_img]:my-0 [&_[data-streamdown-image]_img]:block",
		"[&_[data-streamdown-image]_button]:!top-3 [&_[data-streamdown-image]_button]:!bottom-auto [&_[data-streamdown-image]_button]:!right-3 [&_[data-streamdown-image]_button]:z-20 [&_[data-streamdown-image]_button]:cursor-pointer [&_[data-streamdown-image]_button]:bg-background/90 [&_[data-streamdown-image]_button]:hover:bg-background [&_[data-streamdown-image]_button]:shadow-md [&_[data-streamdown-image]_button]:border [&_[data-streamdown-image]_button]:border-border/80 [&_[data-streamdown-image]_button]:!opacity-0 [&_[data-streamdown-image]:hover_button]:!opacity-100 [&_[data-streamdown-image]_button]:transition-opacity [&_[data-streamdown-image]_button]:duration-200",
		// Tables
